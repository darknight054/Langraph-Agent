...
def main():
    parser = argparse.ArgumentParser(
        description="Process image with DeepSeek OCR using custom prompt"
    )
    parser.add_argument(
        "--prompt",
        type=str,
        help="Custom prompt to use for OCR (overrides default from config)",
    )
    parser.add_argument(
        "--input", type=str, default=INPUT_PATH, help="Input image file path"
    )
    parser.add_argument(
        "--output", type=str, default=OUTPUT_PATH, help="Output directory path"
    )
